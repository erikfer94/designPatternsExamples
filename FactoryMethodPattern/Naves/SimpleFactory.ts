...
class SpaceShip {
	...
	factory: GameFactory; //factory instanciara el game factory para inicializar el juego
	...
	public setGame: stringNumberFunction = (difficulty: string, level: number) => {
		const Game = this.factory.createGame(difficulty, level) //creamos el juego pasando la dificultad como parametro 
...
const newGame = new SpaceShip(new GameFactory());
